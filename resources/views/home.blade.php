...
<body style="background-color: #E2B962; border-radius: 10px; " >
  <!--================Header Menu Area =================-->
  <header class="header_area">
    ...
    <div class="main_menu">
      <div class="container-fluid">
        <nav class="navbar navbar-expand-lg navbar-light w-100" style="background-color: #e3f2fd; border-radius: 10px">
          <!-- Brand and toggle get grouped for better mobile display -->
          <a class="navbar-brand logo_h" href="index.html">
            <img src="img/b4.jpg" alt="" style="height: 75px; border-radius: 10px"  />
          </a>
